...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_56aa3fa6b2eb8',
  'has_nocache_code' => false,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56aa3fa6b2eb8')) {function content_56aa3fa6b2eb8($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<table class="tab" border="0" align="center" cellpadding="0" cellspacing="0">
   <tr>
      ...
      <tr nowrap class="firstalt">
        ...
        <td width="75%"><?php echo '<?'; ?>=$_SERVER['SERVER_NAME']<?php echo '?>'; ?>(127.0.0.1:80)</td>
      </tr>
      <tr nowrap class="firstalt">
        <td width="25%">程序目录：</td>
        <td width="75%">/</td>
      ...
      <tr nowrap class="firstalt">
        ...
        <td width="75%"><?php echo '<?'; ?>=$_SERVER['SERVER_SOFTWARE']<?php echo '?>'; ?></td>
      </tr>
      <tr nowrap class="firstalt">
        <td width="25%">PHP 运行方式：</td>
        <td width="75%"><?php echo '<?'; ?>=PHP_SAPI<?php echo '?>'; ?></td>
      </tr>
      <tr nowrap class="firstalt">
        <td width="25%">PHP版本：</td>
        <td width="75%"><?php echo '<?'; ?>=PHP_VERSION<?php echo '?>'; ?>&nbsp;&nbsp;<span style="color: #999999;">(>5.20)</span></td>
      </tr>
      <tr nowrap class="firstalt">
        <td>MySQL 版本：</td>
        <td><?php echo '<?'; ?>=function_exists("mysql_close")?mysql_get_client_info():NO<?php echo '?>'; ?>&nbsp;&nbsp;<span style="color: #999999;">(>4.20)</span></td>
      </tr>
      <tr nowrap class="firstalt">
        <td>GD库版本：</td>
      ...
      <tr nowrap class="firstalt">
        ...
        <td width="75%"><?php echo '<?'; ?>=defined("OPTIMIZER_VERSION")?OPTIMIZER_VERSION:NO<?php echo '?>'; ?></td>
      </tr>
      <tr nowrap class="firstalt">
        <td width="25%">最大上传限制：</td>
        <td width="75%"><?php echo '<?'; ?>=ini_get('file_uploads') ? ini_get('upload_max_filesize') : '<span style="color:red">Disabled</span>';<?php echo '?>'; ?></td>
      </tr>
      <tr nowrap class="firstalt">
        <td width="25%">最大执行时间：</td>
        <td width="75%"><?php echo '<?'; ?>=ini_get('max_execution_time')<?php echo '?>'; ?> seconds</td>
      </tr>
  
      <tr nowrap class="firstalt">
        <td width="25%">伪静态检测：</td>
        <td width="75%"><?php echo '<?'; ?>=function_exists('iconv_strlen') ? '支持' : '<span style="color:red">不支持</span>'<?php echo '?>'; ?></td>
      </tr>      
    </table>
